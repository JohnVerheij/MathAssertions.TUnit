...
|---|---|---|
| `0.0.x` (MathAssertions.TUnit) | **Current preview** | ✅ Yes |
| `< 0.0.1` | (no prior versions) | n/a |
...
Replace `<package>` (one of `MathAssertions` or `MathAssertions.TUnit`) and `<version>` (e.g. `0.0.1`) with the artifact you downloaded:
