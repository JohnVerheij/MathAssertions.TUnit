...
|---|---|---|
| `0.1.x` (MathAssertions.TUnit) | **Current preview** | ✅ Yes |
| `0.0.x` | Superseded by 0.1 | ❌ No |
...
Replace `<package>` (one of `MathAssertions` or `MathAssertions.TUnit`) and `<version>` (e.g. `0.1.0`) with the artifact you downloaded:
